...
Resource3=IDD_AXIS_DIALOG
Resource4=IDD_AXIS_DIALOG (Chinese (P.R.C.))
Resource5=IDD_ABOUTBOX (Chinese (P.R.C.))
Class4=AxisInformation
Resource6=IDD_ABOUTBOX1 (Chinese (P.R.C.))
...
[DLG:IDD_AXIS_DIALOG (Chinese (P.R.C.))]
Type=1
Class=CAxisDlg
ControlCount=60
Control1=IDC_CHECK1,button,1342242819
...
[CLS:AxisInformation]
Type=0
HeaderFile=AxisInformation.h
ImplementationFile=AxisInformation.cpp
BaseClass=CDialog
Filter=D
LastObject=AxisInformation

[DLG:IDD_ABOUTBOX1 (Chinese (P.R.C.))]
Type=1
